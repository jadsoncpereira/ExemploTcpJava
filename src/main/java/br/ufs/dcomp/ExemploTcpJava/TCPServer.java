...
public class TCPServer{
    public static void main(String[] args) {
        ...
        try {
            ...
            String resposta = "Mensagem transmitida!!!";
            byte[] buf_resposta = resposta.getBytes(); // Obtendo a representação em bytes da mensagem

            System.out.print("[ Enviando confirmação    ..............................  ");
